...
After I made a decision and got things set up to start re-establishing my baseline with Linux Mint, I found out the ethernet port on my new motherboard seems to be defective. Unfortunately, until I can resolve that problem, it seems this will once again be on hold.