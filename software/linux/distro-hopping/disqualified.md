...
In addition, Canonical's stance is contributing to a commonly referenced issue with the Linux desktop: "the fractured experience". In general, I fully believe that the issue of fracturing is often overblown, since most instances of "fracturing" are really "supporting a different use case". However, there is a balance that needs to be struck in the desktop space to avoid confusion and improve support and I do believe that Snaps negatively influence that balance.  
